...
public class MsgListener implements MessageListener{
	...
	public void showNotice() {
		...
		mNotification = new Notification(R.drawable.ic_launcher_background, tickerText, System.currentTimeMillis());
		...
		//mNotification.setLatestEventInfo(context, "提示", tickerText, null);
